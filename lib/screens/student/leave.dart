...
class _LeaveScreenState extends State<LeaveScreen> {
  ...
  // Fetch leave requests from Firestore for the current user
  Future<void> fetchLeaveRequests() async {
    try {
      ...
      // Query Firestore to fetch leave requests for the current user
      QuerySnapshot snapshot = await _firestore
          .collection('leaves')
          .where('studentId', isEqualTo: currentUserUid) // Filter by studentId (UID)
          .get();
